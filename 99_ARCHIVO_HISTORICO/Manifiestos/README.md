...
Preparar la frontera futura para manifiestos verificables de paquetes archivados y documentos sustituidos.
...
Durante C2 no se crean paquetes archivados ni manifiestos efectivos de retiro, sustitución o eliminación.
