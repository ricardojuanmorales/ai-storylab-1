...
Definir la frontera futura para instrumentos, actas y resultados relacionados con gates, checks y evaluaciones controladas.
...
Después de la autorización correspondiente podrán incorporarse gates aprobados, listas de comprobación y resultados formales.
