# Glosario Mínimo SDD para Programador Humanista AI StoryLab 1 v0.4.4

**Estado:** Borrador consolidado para revisión y aprobación documental  
**Ruta canónica propuesta:** `05_COMPETENCIAS_Y_PERFILES/Programador_Humanista/Base_Conocimiento_SDD/Glosario_Minimo_SDD_Programador_Humanista_AI_StoryLab_1_v0_4_4.md`  
...
**Datos educativos:** información vinculada a aprendizaje, evaluación, portafolios, reflexiones o competencias.

**Datos sensibles:** datos que pueden generar daño, exposición, discriminación, vigilancia, vergüenza o pérdida de agencia.

**Deuda:** elemento pendiente que condiciona el avance técnico, documental, ético, pedagógico, de seguridad, privacidad, IA, datos o consentimiento.

**Diferida:** decisión que pospone una spec porque depende de documentos, políticas, matrices o fase futura.
