...
| ------------- | ---------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------ | -------- | -------- | ------------------ |
| `DOC-ARQ-001` | Mapa Funcional Preliminar del Ecosistema | `18_DOCUMENTACION_ACTIVA/Continuidad/v0_6_0/PR_NUEVO/Mapa_Funcional_Preliminar_Ecosistema_AI_StoryLab_v0_6.md` | Arquitectura funcional   | `active` | `yes`    | C3                 |
| `DOC-UX-002`  | Modelo de Experiencia de Usuario         | `18_DOCUMENTACION_ACTIVA/Continuidad/v0_6_0/PR_NUEVO/Modelo_Experiencia_Usuario_AI_StoryLab_v0_6.md`           | Modelo UX                | `active` | `yes`    | C3                 |
| `DOC-UX-003`  | Flujos Funcionales Conceptuales          | `18_DOCUMENTACION_ACTIVA/Continuidad/v0_6_0/PR_NUEVO/Flujos_Funcionales_Conceptuales_AI_StoryLab_v0_6.md`      | Diseño funcional         | `active` | `yes`    | C3                 |
| `DOC-UX-004`  | Recorridos de Usuario Sintéticos         | `18_DOCUMENTACION_ACTIVA/Continuidad/v0_6_0/PR_NUEVO/Recorridos_Usuario_Sinteticos_AI_StoryLab_v0_6.md`        | UX                       | `active` | `yes`    | C3                 |
| `DOC-UX-005`  | Criterios de Accesibilidad y Claridad    | `18_DOCUMENTACION_ACTIVA/Continuidad/v0_6_0/PR_NUEVO/Criterios_Accesibilidad_Claridad_AI_StoryLab_v0_6.md`     | Criterios UX             | `active` | `yes`    | C3                 |
| `DOC-UX-006`  | Criterios de Interacción Humano-IA       | `18_DOCUMENTACION_ACTIVA/Continuidad/v0_6_0/PR_NUEVO/Criterios_Interaccion_Humano_IA_AI_StoryLab_v0_6.md`      | Criterios de interacción | `active` | `yes`    | C3                 |
...
| `DOC-GOB-007` | Marco Estandarizado de Misión            | `18_DOCUMENTACION_ACTIVA/Continuidad/v0_6_0/PR_NUEVO/Marco_Estandarizado_Mision_AI_StoryLab_v0_6.md`           | Marco funcional          | `active` | `yes`    | Evaluación en C3   |
